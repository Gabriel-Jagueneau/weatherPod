...
export default function History() {
    ...
    useEffect(() => {
        async function fetchHistory() {
            try {
                const response = await fetch("https://raw.githubusercontent.com/Gabriel-Jagueneau/plintzy/refs/heads/main/storage/data/users.json");
                                ...
                                <div className="info">
                                    <div className="player-name">
                                        {player.icon && player.icon.length > 0 ? (
                                            <img className="competitor-icon" src={`https://raw.githubusercontent.com/Gabriel-Jagueneau/plintzy/refs/heads/main/${player.icon}`} alt={player.name}/>) : 
